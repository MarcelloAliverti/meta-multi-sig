...
contract MetaMultiSigWallet {
    ...
    function addSigner(address newSigner, uint256 newSignaturesRequired) public onlySelf {
        ...
        require(newSignaturesRequired <= numberOwners+1,"addSigner: signature required must be less then mnumber of owners");
    ...
    function removeSigner(address oldSigner, uint256 newSignaturesRequired) public onlySelf {
        ...
        require(newSignaturesRequired <= numberOwners - 1, "removeSigner: signature required must be less then mnumber of owners");
    ...
    function updateSignaturesRequired(uint256 newSignaturesRequired) public onlySelf {
        ...
        require(newSignaturesRequired <= numberOwners,"addSigner: signature required must be less then mnumber of owners");
        signaturesRequired = newSignaturesRequired;
    }
